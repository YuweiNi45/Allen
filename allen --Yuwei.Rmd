...
cell_intron<-read_csv("mouse_MOp_cells_gene_expression_matrices/mouse_MOp_cells_2018-10-04_intron-matrix.csv")

cell_col<-read_csv("mouse_MOp_cells_gene_expression_matrices/mouse_MOp_cells_samples-columns.csv")
...
if(read_sc) {
  ...
  smart_sce
  save(smart_sce, file = "smarter_cells.rda")
} else {
  load("smarter_cells.rda")
}
pal <- bigPalette
```
...
#plotPCA(smart_sce, colour_by = "seq_name")
plotPCA(smart_sce, colour_by = "sample_id")
plotPCA(smart_sce, colour_by = "sample_type")
plotPCA(smart_sce, colour_by = "organism")
plotPCA(smart_sce, colour_by = "donor")
plotPCA(smart_sce, colour_by = "sex")
plotPCA(smart_sce, colour_by = "age_days")
plotPCA(smart_sce, colour_by = "genotype")
plotPCA(smart_sce, colour_by = "driver_lines")
plotPCA(smart_sce, colour_by = "reporter_lines")
plotPCA(smart_sce, colour_by = "brain_hemisphere")
plotPCA(smart_sce, colour_by = "facs_sort_criteria")
plotPCA(smart_sce, colour_by = "donor_id")
plotPCA(smart_sce, colour_by = "year")
plotPCA(smart_sce, colour_by = "ym")
plotPCA(smart_sce, colour_by = "seq_batch")
plotPCA(smart_sce, colour_by = "percent_aligned_reads_total")
```

## t-SNE

```{r sc_tsne}
plotTSNE(smart_sce, colour_by = "sample_id")
plotTSNE(smart_sce, colour_by = "sample_type")
plotTSNE(smart_sce, colour_by = "organism")
plotTSNE(smart_sce, colour_by = "donor")
plotTSNE(smart_sce, colour_by = "sex")
plotTSNE(smart_sce, colour_by = "age_days")
plotTSNE(smart_sce, colour_by = "genotype")
plotTSNE(smart_sce, colour_by = "driver_lines")
plotTSNE(smart_sce, colour_by = "reporter_lines")
plotTSNE(smart_sce, colour_by = "brain_hemisphere")
plotTSNE(smart_sce, colour_by = "facs_sort_criteria")
plotTSNE(smart_sce, colour_by = "donor_id")
plotTSNE(smart_sce, colour_by = "year")
plotTSNE(smart_sce, colour_by = "ym")
plotTSNE(smart_sce, colour_by = "seq_batch")
plotTSNE(smart_sce, colour_by = "percent_aligned_reads_total")
...
if(read_sn) {
  ...
  save(smart_sne, file = "smarter_nuclei.rda")
} else {
  load("smarter_nuclei.rda")
}
```
...
plotPCA(smart_sne, colour_by = "sample_id")
plotPCA(smart_sne, colour_by = "sample_type")
plotPCA(smart_sne, colour_by = "organism")
plotPCA(smart_sne, colour_by = "donor")
plotPCA(smart_sne, colour_by = "sex")
plotPCA(smart_sne, colour_by = "age_days")
plotPCA(smart_sne, colour_by = "genotype")
plotPCA(smart_sne, colour_by = "driver_lines")
plotPCA(smart_sne, colour_by = "reporter_lines")
plotPCA(smart_sne, colour_by = "brain_hemisphere")
plotPCA(smart_sne, colour_by = "facs_sort_criteria")
plotPCA(smart_sne, colour_by = "donor_id")
plotPCA(smart_sne, colour_by = "year")
plotPCA(smart_sne, colour_by = "ym")
plotPCA(smart_sne, colour_by = "seq_batch")
plotPCA(smart_sne, colour_by = "percent_aligned_reads_total")
...
```{r sn_tsne}
plotTSNE(smart_sne, colour_by = "sample_id")
plotTSNE(smart_sne, colour_by = "sample_type")
plotTSNE(smart_sne, colour_by = "organism")
plotTSNE(smart_sne, colour_by = "donor")
plotTSNE(smart_sne, colour_by = "sex")
plotTSNE(smart_sne, colour_by = "age_days")
plotTSNE(smart_sne, colour_by = "genotype")
plotTSNE(smart_sne, colour_by = "driver_lines")
plotTSNE(smart_sne, colour_by = "reporter_lines")
plotTSNE(smart_sne, colour_by = "brain_hemisphere")
plotTSNE(smart_sne, colour_by = "facs_sort_criteria")
plotTSNE(smart_sne, colour_by = "donor_id")
plotTSNE(smart_sne, colour_by = "year")
plotTSNE(smart_sne, colour_by = "ym")
plotTSNE(smart_sne, colour_by = "seq_batch")
plotTSNE(smart_sne, colour_by = "percent_aligned_reads_total")
...
if(run_combine){
  ...
  save(sce, file = "smarter_cells_nuclei.rda")
  
} else {
  load("smarter_cells_nuclei.rda")
}
```
...
# plotPCA(sce, colour_by = "sample_type")
# plotPCA(sce, colour_by = "organism")
# plotPCA(sce, colour_by = "donor")
# plotPCA(sce, colour_by = "sex")
# plotPCA(sce, colour_by = "age_days")
# plotPCA(sce, colour_by = "genotype")
# plotPCA(sce, colour_by = "driver_lines")
# plotPCA(sce, colour_by = "reporter_lines")
# plotPCA(sce, colour_by = "brain_hemisphere")
# plotPCA(sce, colour_by = "facs_sort_criteria")
# plotPCA(sce, colour_by = "donor_id")
# plotPCA(sce, colour_by = "year")
# plotPCA(sce, colour_by = "ym")
# plotPCA(sce, colour_by = "seq_batch")
# plotPCA(sce, colour_by = "percent_aligned_reads_total")
# 
# 
# plotPCA(sce, colour_by = "donor")
# plotPCA(sce, colour_by = "donor_id")
...
# plotTSNE(sce, colour_by = "sample_type")
# plotTSNE(sce, colour_by = "organism")
# plotTSNE(sce, colour_by = "donor")
# plotTSNE(sce, colour_by = "sex")
# plotTSNE(sce, colour_by = "age_days")
# plotTSNE(sce, colour_by = "genotype")
# plotTSNE(sce, colour_by = "driver_lines")
# plotTSNE(sce, colour_by = "reporter_lines")
# plotTSNE(sce, colour_by = "brain_hemisphere")
# plotTSNE(sce, colour_by = "facs_sort_criteria")
# plotTSNE(sce, colour_by = "donor_id")
# plotTSNE(sce, colour_by = "year")
# plotTSNE(sce, colour_by = "ym")
# plotTSNE(sce, colour_by = "seq_batch")
# plotTSNE(sce, colour_by = "percent_aligned_reads_total")
# 
...
if(run_combine) {
  ...
  reducedDims(sce_small) <- SimpleList()
   ...
   zinb <- zinbwave(sce_small, X = "~ Protocol", K = 2)
...
```{r save}
if(run_combine) {
save(zinb, sce, file = "smarter_cells_nuclei.rda")
}
```
...
```{r}
library(clusterExperiment)
if(packageVersion("clusterExperiment")<'2.1.3-9005') stop("must have current  version of clusterExperiment")

#(GABAergic = inhibitory; Glutamatergic = excitatory).
cellDescript<-"inhibitory neuron"
cellType<-"GABAergic"
tag<-"inhibit"
dataOutput<-file.path("allen40K",tag)
sequential<-FALSE
if(!sequential) tag<-sprintf("%s_noSeq",tag) 
subsample<-FALSE
clusterFunction<-"hierarchical01"
if(!subsample){
tag<-sprintf("%s_noSub",tag) 
clusterFunction<-"pam"
}
...
if(inherits(NCORES,"try-error") || is.na(NCORES)) NCORES<-24
cat(paste0("Number of cores used:",NCORES,"\n"))
...
sequential=sequential,subsample=subsample,
                             betas = c(0.8),
...
#   
# # ############
# # ## Clustering using igraph with subsampling
# # ############
...
trap_wrap <- function(x, k, steps = 4, ...) {
  snn <- buildSNNGraph(x, k = k, d = NA, transposed = FALSE) #scran
  res <- cluster_walktrap(snn, steps = steps) #igraph
...
zinb1<-as.matrix(zinb)
system.time(cl_snn <- clusterSingle(zinb1, subsample = TRUE, sequential = FALSE,
                        ...
                        subsampleArgs = list(resamp.num=100,
                                             samp.p = 0.7,
                                             clusterFunction = SNN,
                                             clusterArgs = list(k = 100),
                                             ncores = NCORES)))

cl_snn <- makeDendrogram(cl_snn, reduceMethod = "zinbwave", nDims = 10)
cl_snn <- mergeClusters(cl_snn, mergeMethod = "adjP", cutoff = 0.1,  logFCcutoff = 1, plotInfo = "mergeMethod")

save(cl_snn, file = "SNN_subsample_cells.rda")

## igraph with sequential

system.time(cl_snn2 <- clusterSingle(zinb, subsample = FALSE, sequential = TRUE,
                         reduceMethod = "zinbwave",
                         nDims = 10,
...
save(cl_snn2, file = "data/zeng/SNN_seq_smarter.rda")

# print(system.time(cl_snn3 <- RSEC(zinb, k0s = c(50, 100, 200), alphas = c(0.1, 0.3),
#                              reduceMethod = "zinbwave",
#                              nReducedDims = 10,
#                              betas = c(0.8),
#                              clusterFunction = "hierarchical01", minSizes=1,
#                              ncores = NCORES, isCount=FALSE,
#                              dendroReduce="zinbwave", dendroNDims=10,
#                              subsampleArgs = list(resamp.num=100,
#                                                   clusterFunction=SNN),
#                              verbose=TRUE,
#                              consensusProportion = 0.7,
...
#                              consensusMinSize = 10, run = TRUE)))
#
# save(cl_snn3, file = "data/zeng/SNN_RSEC_smarter.rda")
...
# 
# cl_seu <- ClusterExperiment(zinb, as.matrix(seu@meta.data[,4:13]))
# # cl_seu <- consensusMany(cl_seu, whichClusters = 1:10, proportion = 0.7)
# #
# # save(cl_seu, file = "data/zeng/Seurat_cells.rda")
